        ...
        <Container variant="content">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="type-h1 text-white mb-5 max-w-2xl">
                {page.title}
              </h1>

              {page.short_body && (
                <p className="type-body-lg text-brand-200 mb-8 max-w-xl">
                  {page.short_body}
                </p>
              )}
      ...
      <section className="bg-white py-16 lg:py-24" aria-label="Inhoud">
        <Container variant="content">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12 lg:gap-16 items-start">
            ...
            {bodyHtml ? (
              <div
                className="rich-text [&_h2+h2]:border-t [&_h2~h2]:border-t [&_h2~h2]:border-neutral-200 [&_h2~h2]:pt-8"
            ...
            <aside className="lg:sticky lg:top-24 space-y-5 h-fit">
              ...
              <Card hover={false}>
                <div className="border-l-4 border-brand-700 pl-4">
                  <h3 className="type-h3 text-brand-900 mb-2">
                    Meer weten?
                  </h3>
