      ...
      <div className="mx-auto w-full max-w-lg text-center">
        <div>
          ...
          <p className="md:text-md">
            Plan een verkenning en ontvang binnen enkele dagen een concreet
            voorstel voor aanpak en doorlooptijd.
          </p>
          <div className="mx-auto mt-6 w-full max-w-sm md:mt-8">
            ...
            <p className="text-xs">
              We nemen binnen twee werkdagen contact met u op om een moment te
              plannen.
            </p>
          </div>
        </div>
