...
export function Layout358_1({ contrast: c, apiOnly = false } = {}) {
  if (apiOnly) {
    const card = c?.card;
      ...
      <div className="w-full">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Waarom traditionele IT niet werkt
            </h2>
            <p className="md:text-md">
              Lange planningsfases. Late levering. Oplossingen die te laat
        ...
        <div className="grid auto-cols-fr grid-cols-1 border border-border-primary md:grid-cols-2">
          <div className="flex flex-col justify-center p-6 md:p-8 lg:p-12">
            <div>
              <p className="mb-2 text-sm font-semibold">Probleem</p>
              <h3 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                Maanden voorbereiding voordat er iets gebeurt
              </h3>
              <p>
                Uw organisatie staat stil terwijl er plannen worden gemaakt. Pas
                maanden later wordt er iets gebouwd — vaak te laat en niet meer
                passend bij de werkelijkheid.
              </p>
            </div>
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              <CtaFromUrl
