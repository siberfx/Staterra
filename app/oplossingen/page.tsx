...
export const metadata: Metadata = {
  title: 'Oplossingen',
  description:
    'Van maatwerk tot open source Woo-oplossingen. Direct inzetbaar, zonder vendor lock-in.',
...
export default async function OplossingsoverzichtPage() {
  const result = await getSolutions();
  const solutions = result?.data ?? [];
  const bannerUrl = result?.banner;
