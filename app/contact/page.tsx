...
import { getContact, getSettings } from '@/lib/cms';
...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Neem contact op voor een vrijblijvende verkenning. Binnen twee werkdagen een inhoudelijke reactie.',
            ...
            <aside aria-label="Contactgegevens en informatie" className="space-y-6">
              ...
              <Card hover={false} padding="compact">
                ...
                <ul className="space-y-2">
                  {[
                    { href: '/woo-oplossing', label: 'De Woo-oplossing (OPMS)' },
                    { href: '/aanpak', label: 'Onze aanpak in 3 fasen' },
                    { href: '/samen-ontwikkelen', label: 'Samen nieuwe oplossingen bouwen' },
