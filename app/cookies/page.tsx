...
export const metadata: Metadata = {
  ...
  description:
    'Lees welke cookies Staterra gebruikt, waarom, en hoe u uw voorkeuren kunt aanpassen.',
      ...
      <Container variant="content" className="py-12 lg:py-20">
        <div className="max-w-[760px]">
          ...
          <nav className="flex items-center gap-2 text-caption text-neutral-500 mb-10" aria-label="Breadcrumb">
            <Link href="/" className="hover:text-brand-700 transition-colors duration-[150ms]">Home</Link>
            <span aria-hidden="true">/</span>
