...
export const metadata: Metadata = {
  title: 'Kennisbank',
  description:
    'Artikelen, handleidingen en achtergronden over Woo-compliance, open source en digitale publieke sector.',
  alternates: { canonical: '/kennisbank' },
  openGraph: {
    title: 'Kennisbank — Staterra',
    description:
      'Verdieping over Woo, open source en digitale publieke infrastructuur.',
    type: 'website',
  },
};
