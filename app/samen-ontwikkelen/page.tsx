...
export const metadata: Metadata = {
  ...
  description:
    'Geen outsourcing maar samenwerking. Van vraagstuk naar werkend systeem in 3 maanden.',
  alternates: { canonical: '/samen-ontwikkelen' },
};
...
export default async function SamenOntwikkelenPage() {
  const solution = await getSolution('samen-ontwikkelen');
