...
export const metadata: Metadata = {
  ...
  description:
    'Projectmanagement, Woo-consultancy, architectuur, training. Het team achter het platform.',
  alternates: { canonical: '/dienstverlening' },
};
...
const DIENSTEN = [
  {
    ...
    beschrijving:
      'Een ervaren projectmanager die planning, communicatie en oplevering coördineert — van eerste verkenning tot werkend systeem in productie. Spreekt de taal van zowel IT als bestuurstafel.',
    details: [
      'Coördinatie van alle betrokken partijen (intern en extern)',
  ...
  },
  {
    ...
    beschrijving:
      'Specialistisch advies over de Wet open overheid: publicatieprocessen, informatiehuishouding, categorieën actieve openbaarmaking en werkprocessen. Van beleid naar praktijk.',
    details: [
...
const TRAININGEN = [
  ...
  },
  {
    ...
    inhoud: 'Inrichting, configuratie en beheer van OPMS. Categorieën, gebruikersbeheer, rapportages en integratiebeheer.',
    vorm: ['Klassikaal', 'On-site'],
  },
  {
        ...
        <Container variant="text">
          <div className="text-center">
            ...
            <p className="text-body text-neutral-700 leading-relaxed">
              ...
              de oplevering coördineert, de Woo-consultant die de inrichting
