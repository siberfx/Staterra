...
export const metadata: Metadata = {
  title: 'Open source',
  description:
    'Volledige regie over uw digitale systemen. Open source als strategische keuze voor de overheid.',
...
export default async function OpenSourcePage() {
  const solution = await getSolution('open-source');
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-[16px] border border-brand-700 bg-white p-5 flex items-start gap-4">
                ...
                <p className="text-body-sm text-neutral-700">
                  ...
                  Meer dan 530 bestuursorganen moeten binnen 8 tot 18 maanden
